...
include(BASE_PATH.'/system/database.php');
include(BASE_PATH.'/system/libs/functions.php');
include(BASE_PATH.'/system/libs/database/'.$config['sql_extenstion'].'.php');
...
foreach ($configs as $con){ $site[$con['config_name']] = $con['config_value']; }
unset($configs); 
...
if(file_exists(BASE_PATH.'/languages/en/base/lang.php') && $CONF['language'] != 'en'){ 
...
/* All rights reserved (c) MafiaNet - MN-Shop.net */
?>