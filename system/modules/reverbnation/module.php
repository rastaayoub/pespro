...
<div class="follow<?=($sit['premium'] > 0 ? '_vip' : '')?>" id="<?=$sit['id']?>">
	<center>
		...
		<a href="javascript:void(0);" onclick="ModulePopup('<?=$sit['id']?>','<?=hideref($sit['url'])?>','ReverbNation','<?=$check_acc['account_username']?>');" class="followbutton"><?=$lang['reverbnation_05']?></a>
